...
* Ruby version - 2.2 or better. Make sure you have to_h.

* System dependencies

* Configuration

* Database creation - Use postres

* Database initialization - After db setup, run rake task in scrape.rake and meeting_properties.rake.
